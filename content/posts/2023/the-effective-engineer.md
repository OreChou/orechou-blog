...
readingTime: "Unknown"
summary: 本书总结出一个强大的框架——杠杆率，用来推断、分析工作的有效性与影响力，包含了一系列可落地且经过验证的策略作为框架的补充，读者可以立即应用这些策略来提高工作成效。全书分为三个部分，第一部分从提高成效的思维模式切入，第二部分深入探讨持续提升执行力并取得工作进展的关键策略，在第三部分作者转换角度，阐述了创造长期价值的方法。
tags: ["book"]
---
